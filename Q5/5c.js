    ...
    */
        ...
        vec3 lColor, vec3 lPos, vec3 N, vec3 V, vec3 kd, vec3 ks, float shin)
    {
        ...
        */
        ...
        vec3  specular = ks * lColor * pow(RdotV, shin) * step(0.0, NdotL);
        float atten = 1.0 / (1.0 + 0.09 * d + 0.032 * d * d);
        vec3 result = (diffuse + specular) * atten;
        return result; // Dummy return value. Please change this
    }
    ...
    //shaderMat.setFloat("uMatAmbient", 0.5)
    shaderMat.setColor3("uMatDiffuse",  new BABYLON.Color3(0.8, 0.2, 0.2));
    //shaderMat.setColor3("uMatDiffuse",  new BABYLON.Color3(0.1, 0.5, 0.5));
    shaderMat.setColor3("uMatSpecular", new BABYLON.Color3(1, 1, 1));
    //shaderMat.setColor3("uMatSpecular", new BABYLON.Color3(1, 0.6, 0.3));
    shaderMat.setFloat("uMatShininess", 32.0);
    //shaderMat.setFloat("uMatShininess", 20.0);

    // Point Light
    shaderMat.setColor3("uPointLightColor", new BABYLON.Color3(0.7, 0.8, 1.0));
    //shaderMat.setColor3("uPointLightColor", new BABYLON.Color3(0.3, 0.8, 0.5));
    shaderMat.setVector3("uPointLightPos", new BABYLON.Vector3(2.5, 4, -2.0));
    //shaderMat.setVector3("uPointLightPos", new BABYLON.Vector3(2.5, 4, 2.0));

    // Second Light
    shaderMat.setColor3("uPointLightColor2", new BABYLON.Color3(0.7, 0.8, 1.0)); 
    shaderMat.setVector3("uPointLightPos2", new BABYLON.Vector3(-3, 2, 2));       
